    ...
    public DictionaryConnection(String host, int port) throws DictConnectionException {
    	try {
			...
			if (response.contains("220")) {
				System.out.println("Connected! Welcome message: " + response);
			} else {
				System.out.println("Error: Expected code 220 but received "+ response);
				throw new DictConnectionException();
			}
		} catch (IOException e) {
			System.out.println("Error: Connection to " + host + " has failed");
			throw new DictConnectionException();
		}
    }
